...
<section class="container my-5 text-center align-items-center mx-auto">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 col-lg-5 my-auto">
            <h2 class="heading d-none d-lg-block my-2 text-left ml-xl-3">OFFICIAL E-CELL MERCHANDISE</h2>
            ...
            <div class="text-center d-xl-flex flex-row sizebtn" style="color: #919191;">
